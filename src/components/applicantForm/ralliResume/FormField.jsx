...
const FormField = ({ item, form, index, handleChange, handleEnhanceAi, states, cities, checkedLabel }) => {
    ...
    if (item.name === "start_date" || (item.name === "end_date" && !form.is_continue)) {
        return (
                    ...
                    InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
                                <Button
                                    onClick={() =>
                                        handleEnhanceAi(index, form[item.name])
                                    }
                                    sx={{
                                        position: "absolute",
                                        bottom: 4,
